...
db.execute("""
    INSERT INTO TAGS VALUES ('#тест', 1076800), ('#киберfire', 1030787), ('#конкурс', 1017367), ('#новости', 1020555), ('#киберsale', 1017366), ('#анонс', 1017119), ('#киберnews', 1016793), ('#nурниры', 1016042)
""")
