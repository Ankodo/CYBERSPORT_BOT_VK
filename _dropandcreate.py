...
db.execute("""
    INSERT INTO TAGS VALUES ('#киберfire', 1030787), ('#розыгрыш', 1017367), ('#киберsale', 1017366), ('#twitch', 1017119), ('#турниры', 1016042), ('#youtube', 1076800), ('#discord', 1089711), ('#настолки', 1089710)
""")
